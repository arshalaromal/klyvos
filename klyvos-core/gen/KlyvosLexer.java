...
public class KlyvosLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"USE", "VAR", "CONST", "NULL", "FN", "IF", "ELSE", "WHILE", "FOR", "IN", 
			"AND", "OR", "NOT", "BREAK", "CONTINUE", "RETURN", "BOOLEAN", "STRING", 
			"HEXDIGIT", "DECIMAL", "INTEGER", "IDENTIFIER", "PLUS", "MINUS", "SLASH", 
			"EXP", "STAR", "MOD", "EQUALS", "ASSIGN", "NEQ", "LE", "GE", "LT", "GT", 
			"LPAREN", "RPAREN", "LBRACE", "RBRACE", "LBRACK", "RBRACK", "DOT", "COMMA", 
			"COLON", "SCOLON", "COMMENT", "NEWLINE", "WS"
		};
	}
	...
	public KlyvosLexer(CharStream input) {
		super(input);
